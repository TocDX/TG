...
<html lang="en">
    ...
    <div class="container-xxl" style="margin-top: 120px;">
        <h1 class="fw-bold">회원정보수정</h1>
        <hr>
        <form method="GET" action="${pageContext.request.contextPath}/update" enctype="multipart/form-data">
            ...
            <button type="submit" class="d-flex btn btn-primary" style="justify-content: end">수정</button>
        </form>
    </div>
